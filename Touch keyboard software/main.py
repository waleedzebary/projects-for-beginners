...
keyboard_keys = [["Q", "W", "E", "R", "T", "Y", "U", "I", "0", "P"],
                 ["A", "S", "D", "F", "G", "H", "J", "K", "L", ";"],
                 ["Z", "X", "C", "V", "B", "N", "M", ",", ".", "/"]]
final_text = ""
keyboard = Controller()
...
def transparent_Layout(img, buttonList):
    ...
    for button in buttonList:
        x, y = button.pos
        cvzone.cornerRect(imgNew, (button.pos[0], button.pos[1], button.size[0], button.size[0]), 20
                          , rt=0)
        cv2.rectangle(imgNew, button.pos, (x + button.size[0], y + button.stze[1]), (255, 144, 30),
                      cv2.FILLED)
